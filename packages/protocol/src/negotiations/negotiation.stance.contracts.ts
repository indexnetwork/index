...
- SCORE ONLY FROM WHAT SOMEONE STATED: a dimension may be scored ok or conflict from the commitment record alone — what the two principals themselves put on the record about what they want: their own intents, the premises they hold, and the answers they have given in this negotiation. Write that commitment into the dimension's basis. A score with nothing behind it is an assertion rather than a finding, and it belongs back at unknown.
