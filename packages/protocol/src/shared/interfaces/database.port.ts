...
import type { EnrichmentGraphDatabase, HydeGraphDatabase, IntentGraphDatabase, IntentNetworkGraphDatabase, NetworkGraphDatabase, NetworkMembershipGraphDatabase, OpportunityGraphDatabase } from './database.capabilities.js';
...
export interface Database extends
  DatabaseIdentityQueries,
  DatabaseNetworkQueries,
  DatabaseOpportunityQueries,
  DatabaseMemberQueries {}
