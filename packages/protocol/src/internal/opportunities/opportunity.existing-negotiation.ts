import type { ActiveIntent, NegotiationContinuationExecution, NegotiationContinuationReceipt, Opportunity, OpportunityGraphDatabase } from '../../platform/database.js';
...
/**
 * The opportunity actor's exact intent, and nothing else — a negotiation
 * carries only the signal it is bound to.
 */
