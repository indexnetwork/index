...
import type { ActiveIntent, OpportunityActor } from '../../platform/database.js';import { NEGOTIATION_MAX_TURNS_AMBIENT, NEGOTIATION_MAX_TURNS_CHAT } from "../negotiations/negotiation.protocol.js";
