/**
 * Unit tests for chat tools (createChatTools, read_intents, read_indexes, read_users, list_opportunities, update_opportunity, etc.).
 */
/** Config */
...
const mockProtocolDeps: Omit<ToolContext, 'userId' | 'database' | 'embedder' | 'scraper' | 'indexId' | 'sessionId' | 'userDb' | 'systemDb'> = {
  ...
  } as unknown as import("../../../../platform/database.js").NegotiationGraphDatabase,
  ...
  }) as unknown as import("../../../../platform/database.js").UserDatabase,
  ...
  }) as unknown as import("../../../../platform/database.js").SystemDatabase,
};
