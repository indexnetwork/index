...
export type OnNegotiationResolved = (entry: {
  ...
  continuationReceipt?: import('../../platform/database.js').NegotiationContinuationReceipt;
}) => Promise<void>;
...
export async function negotiateCandidates(
  ...
  opts?: {
    ...
    continuationExecution?: import('../../platform/database.js').NegotiationContinuationExecution;
  },
