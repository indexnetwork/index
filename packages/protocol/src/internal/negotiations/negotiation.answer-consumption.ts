...
import type { NegotiationGraphDatabase, NegotiationUserAnswer } from "../../platform/database.js";
import type { QuestionBlock, QuestionBlockQuestion } from "../../protocol/question-block.schema.js";
