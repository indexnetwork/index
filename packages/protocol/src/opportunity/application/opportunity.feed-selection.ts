import type { DeliveryLedger } from '../../shared/interfaces/delivery-ledger.interface.js';
import type { ChatGraphCompositeDatabase, Opportunity, OpportunityStatus } from '../../shared/interfaces/database.interface.js';
import { deduplicateByPerson, selectByComposition, selectDigestCandidates, type DigestDeliveredRow } from '../domain/opportunity.utils.js';
