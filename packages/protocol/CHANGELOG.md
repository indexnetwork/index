...
### Added
- Harden reporter turn handling so only the exact kickoff produces the detailed briefing, focused follow-ups stay narrow, and contextual natural-language confirmation deterministically bypasses the model and tools in favor of the visible confirmation card (IND-493).
