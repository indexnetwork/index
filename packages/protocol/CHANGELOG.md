...
### Added
- Harden reporter turn guidance so only the exact kickoff produces the detailed briefing, focused follow-ups stay narrow, and natural-language confirmation cannot execute or create cleanup proposals (IND-493).
