...
Agent skills for **Edge Esmeralda 2026** (May 30 – Jun 27, Healdsburg, CA). Shipped with [edge-hermes](../README.md); also installable on Claude Code, OpenClaw, and other MCP hosts.
...
```bash
hermes skills install Edge-City/edge-hermes/skills/edge-esmeralda --force
hermes skills install Edge-City/edge-hermes/skills/edgeos --force
hermes skills install Edge-City/edge-hermes/skills/index-network --force
```
...
For Hermes with workspace + installer, use [edge-hermes](https://github.com/Edge-City/edge-hermes). For OpenClaw, use [agentvillage](https://github.com/Edge-City/agentvillage).
