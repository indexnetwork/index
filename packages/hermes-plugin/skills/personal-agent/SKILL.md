...
Take at most one recorded turn per match work ID. A sweep contains several separate match decisions. After a submission attempt, do not retry or ask another question: end that match decision and summarize the tool result honestly. Other matches may continue. A failed or uncertain write is not success. Do not force a particular outcome or number of turns.
