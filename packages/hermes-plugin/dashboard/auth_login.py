...
3. The web app mints a user API key and redirects to the callback with
   `api_key` + `key_id`.
4. Persist that key. It authenticates as the user; which agent speaks for
   them is `GET /agents/me`.
