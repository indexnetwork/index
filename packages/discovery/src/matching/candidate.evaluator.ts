...
import { getAbortSignalConfig, requestContext, timed } from '../core/runtime.js';
import type { AgentTiming, MatchEvidence } from '../core/types.js';
import { REJECTION_COOLDOWN_MS, REJECTION_COOLDOWN_SIMILARITY_PENALTY } from './discovery.constants.js';
import type { CandidateMatch, DiscoveryDeps, DiscoveryState, EvaluatedOpportunity, EvaluatorEntity, MatchExplainerInput, TraceEntry } from './discovery.state.js';
import { evaluationLog, safeDiscoveryError } from './discovery.trace.js';
import { mergeMatchEvidence } from './match.evidence.js';
