...
const ShareModal = ({
	...
	return <Modal
		...
		body={(
			<Row>
				<Col xs={12}>
					<Text className="mt-0 mb-6" element="p" fontWeight={600}>Visibility</Text>
					<Flex
						alignItems="center"
						className="mb-5"
					>
						...
						<Flex flexDirection="column" flexWrap="wrap" flexGrow={1} className="ml-6">
							<Text>Public</Text>
				...
				<Col xs={12} className="mt-3">
					<Text className="mt-0 mb-6" element="p" fontWeight={600}>Invite collaborators by username or email</Text>
					<UserSearchInput />
				</Col>
				<Col xs={12}>
					<UserCard className="py-5" owner showUserRight right="view" title="cnsndeniz@gmail.com" subtitle="Hasn't joined yet, tap to send invitation" />
					<UserCard className="py-5" showUserRight right="view" title="cnsndeniz@gmail.com" subtitle="Hasn't joined yet, tap to send invitation" />
					<UserCard className="py-5" showUserRight right="view" title="cnsndeniz@gmail.com" subtitle="Hasn't joined yet, tap to send invitation" />
				</Col>
				<Col xs={12}>
					<InviteByLink />
