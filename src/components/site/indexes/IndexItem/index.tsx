...
>
	...
	>
		...
		<Text className="ml-3" size="sm" verticalAlign="middle" fontWeight={500} element="span">{index.controller_did.id || ""}</Text>
	</Col>
	<Col
		xs={12}
		className="mb-2"
	...
	<Col xs={12}>
		<Text size="sm" theme="disabled">Updated {index.updated_at ? moment(index.updated_at).fromNow() : ""}</Text>
	</Col>
	{
