...
Catalogue for **step 5 (T3 focused refactors)** of `clean-codebase`. Use a *named*
...
- The change spans schema/layers → that's **T4**, not T3; follow `verify-production-release`.
