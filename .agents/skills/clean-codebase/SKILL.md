...
- **Branch guard:** the canonical root `/Users/yanek/Projects/index` must stay on `dev`
  ...
  `git worktree add` + `bun run worktree:setup` per `.agents/skills/create-worktree/SKILL.md`.
...
## See also
- `.agents/skills/create-worktree/SKILL.md` — mandatory for any mutating work
- `.agents/skills/verify-production-release/SKILL.md` — before any destructive migration reaches main
