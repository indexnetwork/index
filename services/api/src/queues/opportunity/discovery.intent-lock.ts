 ...
 * enqueue for X is admitted and — now that the discovery worker runs several
...
const LOCK_KEY_PREFIX = 'opportunity:discovery:running:';

const RELEASE_LUA = `
-- discovery lock release: only the holder may delete.
 ...
 * DiscoveryQueue instance in a process sees the same locks.
 */
