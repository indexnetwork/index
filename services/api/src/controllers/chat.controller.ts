...
export class ChatController {
   ...
   * authenticated user's authoritative onboarding record is incomplete, and it
   * always runs the restricted persisted onboarding persona.
   */
  ...
  async getSessions(req: Request, user: AuthenticatedUser) {
    // The explicit negotiator filter backs the pinned Personal Agent lookup.
    // Without it this lists retired-orchestrator history, which stays readable;
