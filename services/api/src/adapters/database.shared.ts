...
export interface IntentListRow {
  ...
  sourceId: string | null;
  /**
   * Networks this intent is currently registered to. Empty when the owner
   * shared it nowhere, which lets the UI surface orphaned intents instead of
   * hiding the assignment outcome.
   */
...
export const { intents, networks, networkMembers, networkJoinRequests, intentNetworks, users, opportunities, negotiations, negotiationTurns, userNotificationSettings, sessions, userSocials } = schema;
