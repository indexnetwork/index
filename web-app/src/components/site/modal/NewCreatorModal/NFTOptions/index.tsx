...
// const NFTOptions: React.VFC<SelectNFTOptionsProps> = ({
//   handleBack,
//   handleCreate,
// }) => {
//   const { api } = useApi();
...
//       return errors;
//     }
//     const contractData = await api.getContract(
//       values.chain,
...
//     handleCreate &&
//     handleCreate(getCondition(values) as AccessControlCondition);
//   const {
//     setFieldValue,
//     setFieldError,
//     setFieldTouched,
...
//           </Flex>
//         </Col>
//         {!errors.contractAddress && standardContractType === "ERC721" && (
//           <Col className="mt-6" xs={12}>
//             <Flex flexdirection="column">
//               <Text theme={"primary"} size="md" className={"mb-3"}>
//                 Give rights to:
//               </Text>
//               <RadioGroup
//                 key="rightType"
//                 value={values.rightType}
//                 onSelectionChange={(value) => setFieldValue("rightType", value)}
//                 colSize={6}
//                 items={[
//                   {
//                     value: "any",
...
//           </Col>
//         )}
//         {((!errors.contractAddress && standardContractType === "ERC1155") ||
//           (standardContractType === "ERC721" &&
//             values.rightType === "specific")) && (
//           <Col className="mt-6" xs={12}>
//             <Flex flexdirection="column">
//               <Text theme={"primary"} size="md">
//                 Token ID:
...
//                 inputSize={"lg"}
//                 error={
//                   touched.tokenId && errors.tokenId ? errors.tokenId : undefined
//                 }
//                 onChange={handleChange}
//                 onBlur={handleBlur}
//                 className="mt-3"
...
//           </Col>
//         )}
//         {((!errors.contractAddress && standardContractType === "ERC20") ||
//           (!errors.contractAddress && standardContractType === "ERC1155") ||
//           (!errors.contractAddress &&
//             standardContractType === "ERC721" &&
//             values.rightType === "any")) && (
//           <Col className="mt-6" xs={12}>
//             <Flex flexdirection="column">
//               <Text theme={"primary"} size="md">
//                 How many token does the wallet need to own:
//               </Text>
//               <Input
//                 placeholder="##"
//                 step={1}
...
//                 name="minTokens"
//                 error={
//                   touched.minTokens && errors.minTokens
//                     ? errors.minTokens
//                     : undefined
//                 }
//                 onChange={handleChange}
