  ...
  <LandingSection>
    ...
    >
      <FlexRow className="pb-5">
        <Col xs={12} md={9}>
          <Header className="lnd-section-title">
            Collaborate on two-person projects up to DAO-scale. Monetize
            independently.
          </Header>
        </Col>
      </FlexRow>
      <FlexRow align={"center"}>
        ...
        <Col sm={12} lg={6}>
          <img
            className={cm.img}
            alt="landing-2-img"
            src="/images/screen-multiplayer.png"
          />
        </Col>
      </FlexRow>
    </Flex>
