  ...
  <LandingSection dark>
    ...
    >
      <Flex
        ...
        className="lnd-title mb-2"
      >
        <Header className="lnd-section-title" theme="gray6">
        ...
        <Text
          ...
          className={"mb-0 mt-5"}
        >
          Creating a discovery ecosystem as a network promotes greater
          participation in
          <br /> decentralized discovery and contributes to a diverse and
          inclusive web.
        </Text>
        <img
          className={"px-lg-10"}
