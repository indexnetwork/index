...
- **@indexnetwork/protocol**: graph/tool factories injected with API-service adapters.

## Consumers
- **Web app/CLI/Claude plugin/MCP clients**: call API HTTP and `/mcp` endpoints.
...
- Protocol package receives API-service implementations through constructor/interface injection.

<important if="you are adding API runtime wiring">
