...
phases:
  ...
  - { n: 3, title: Assignment writes }
  - { n: 4, title: Opportunity visibility }
  - { n: 5, title: Question visibility }
  - { n: 6, title: Regression tests }
...
- Phase 3: Assignment writes — pending
- Phase 4: Opportunity visibility — pending
- Phase 5: Question visibility — pending
- Phase 6: Regression tests — pending
