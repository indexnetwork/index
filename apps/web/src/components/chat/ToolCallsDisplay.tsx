...
const GRAPH_DISPLAY_NAMES: Record<string, string> = {
  ...
  "intent": "Signal graph",
  "intent_index": "Signal indexing",
  "intent_network": "Signal indexing",
...
const AGENT_DISPLAY_NAMES: Record<string, string> = {
  ...
  "opportunity-resolve": "Resolving trigger signal",
  ...
  "intent-inferrer": "Inferring signals",
  "intent-verifier": "Verifying signals",
  "intent-reconciler": "Reconciling signals",
  "intent-networker": "Indexing signals",
