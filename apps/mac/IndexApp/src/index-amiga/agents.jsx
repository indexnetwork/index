...
function NegotiatorProfile({ agent, onOpenMemory, onOpenHistory }) {
  const btn = {
...
function Agents({ onClose, onOpenMemory, onOpenHistory }) {
  ...
  // The Personal Agent avatar is derived from the account identity and stays
  // stable across runtime changes; this pane intentionally has no shuffle UI.
