  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <MacWindow title="index · your feed">
          <ConversationPane
            profile={profile}
        ...
        <MacWindow title="index · your pipeline">
          <MatchFeed
    ...
    <div style={{
      ...
      <div ref={scrollRef} onScroll={onScroll} className="mac-scroll" style={{
        ...
        <div style={{
          ...
          <span>index's listening · more will surface as the field changes</span>
...
function ClarifierCard({ item, onAnswer, onDismiss }) {
  ...
  return (
    <div className="fade-up"
      ...
      {/* top row — keep it concise: who it's from + when */}
      <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:8, flexWrap:"wrap" }}>
        {(item.source === "agent" || item.source === "individual" || !item.source) && (
