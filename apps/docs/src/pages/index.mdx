...
**[Opportunity](/opportunity)** — the record of one pair. An agent creates it
when it opens a negotiation with a candidate, and it reaches the people
involved when their agents agree, with the reasoning for why it is worth each
person's time.
