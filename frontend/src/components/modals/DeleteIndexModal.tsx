...
export default function DeleteIndexModal({ 
  open, 
  onOpenChange, 
  index, 
  onDeleteIndex, 
        ...
        <Dialog.Content className="fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border bg-white p-6 shadow-lg duration-200 sm:rounded-lg mx-auto">
          <div className="flex flex-col space-y-1.5 text-center sm:text-left">
            ...
            <Dialog.Description className="text-sm text-gray-500">
              Are you sure you want to delete "{index?.title}"? This action cannot be undone and will permanently delete all files and data associated with this index.
            </Dialog.Description>
          </div>
