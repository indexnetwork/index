                ...
                <div className="space-y-2">
                  {profileData.socials.x && (
                    <a
                      ...
                      className="flex items-center gap-3 text-gray-700 hover:text-black transition-colors font-ibm-plex-mono"
                    >
                      <svg className="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                      </svg>
                      <span>{profileData.socials.x.startsWith('@') ? profileData.socials.x : `@${profileData.socials.x}`}</span>
                    </a>
                  )}
                  {profileData.socials.linkedin && (
                    ...
                    >
                      ...
                      <span>{profileData.socials.linkedin}</span>
                    </a>
                  )}
                  {profileData.socials.github && (
                    ...
                    >
                      ...
                      <span>{profileData.socials.github}</span>
                    </a>
                  )}
