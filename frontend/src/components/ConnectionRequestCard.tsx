...
export default function ConnectionRequestCard({
  ...
  return (
    <div className="p-0 mt-0 bg-card border border-b-2 border-foreground mb-4">
      <div className="py-4 px-2 sm:px-4">
        ...
        <div className="flex flex-wrap sm:flex-nowrap justify-between items-start mb-4">
          <div className="flex items-center gap-4 w-full sm:w-auto mb-2 sm:mb-0">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <h2 className="font-bold text-lg text-foreground font-ibm-plex-mono">{initiator.name}</h2>
                <p className="text-sm text-muted-foreground font-ibm-plex-mono">Requesting</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <h2 className="font-bold text-lg text-foreground font-ibm-plex-mono">{receiver.name}</h2>
                <p className="text-sm text-muted-foreground font-ibm-plex-mono">To connect</p>
              </div>
            </div>
          </div>
        ...
        {(synthesisLoading || synthesis) && (
          <div className="mb-4">
            <h3 className="font-medium text-foreground mb-2 text-sm">What Could Happen Here</h3>
            {synthesisLoading ? (
