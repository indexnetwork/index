...
A parked pre-contact negotiation is **not yet rendered** on the radar — it is neither "passed" nor an open negotiation. An "asking you first" state is a follow-up.
