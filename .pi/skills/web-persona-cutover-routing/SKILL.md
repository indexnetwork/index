---
name: web-persona-cutover-routing
...
- **flag-rollout-consistency** — ship the new route/persona dark, then flip Railway and
  the local mirror only with explicit approval.
- **connect-link-routing-safety** — related guidance for server-vs-client surface
  routing decisions.
