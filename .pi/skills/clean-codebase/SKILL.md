...
- **Branch guard:** the canonical root `/Users/yanek/Projects/index` must stay on `dev`
  ...
  `git worktree add` + `bun run worktree:setup` per `.pi/skills/create-worktree/SKILL.md`.
...
## See also
- `.pi/skills/create-worktree/SKILL.md` — mandatory for any mutating work
- `.pi/skills/verify-production-release/SKILL.md` — before any destructive migration reaches main
