...
description: "Run packages/protocol evals across live baseline-backed harnesses, the staged HyDE study, the clarification taxonomy, the budgeted live canary, and the provider-free eval:verify gate. Use when running or verifying evals, adding a harness, updating a baseline, or fixing eval:verify inventory/coverage failures."
...
See also: `verify-production-release` (pre-merge gates).
