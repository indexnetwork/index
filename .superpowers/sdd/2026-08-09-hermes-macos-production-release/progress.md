...
Task 6: owner-authorized exceptional fix round 7/7 (validation-before-posture and empty-history availability addressed; review pending; Task 6 not complete)
Task 6: owner-authorized exceptional fix round 8/8 (original tag authority validated before lossy shell transport; review pending; Task 6 not complete)
Task 6: complete after final whole-branch fix wave (private candidate/later evidence-authorized publish transaction, exact-byte/attestation/CMS revalidation, no candidate/tag publication; provider-free coverage complete; final re-review pending)
Task 7: complete after final whole-branch fix wave (immutable GitHub request authority plus approved HTTPS release-assets redirect/final URL validation; realistic redirect tests; final re-review pending)
Task 8: complete after final whole-branch fix wave (schema-v2 exact two-architecture independently approved evidence bound to both DMGs/candidate seal/attestation/floor; executable failure/success matrix; final re-review pending)
