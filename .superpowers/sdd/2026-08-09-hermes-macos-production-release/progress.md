...
Task 5: fix round 1/5 (1 Critical + 7 Important addressed, review pending; exact schema evaluation, descriptor/no-clobber safety, unique hash-pinned CMS identity, real DER fixtures; no identity used)
