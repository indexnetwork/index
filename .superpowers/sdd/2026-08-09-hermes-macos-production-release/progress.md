...
Task 5: fix round 2/5 (4 Important addressed, review pending; private CMS signer pin, explicit no-clobber status, closed schema vocabulary, stable CMS snapshot; no identity used)
